...
var algos = module.exports = global.algos = {
    ...
    poly: {
        hash: function(){
            return function(){
                return multiHashing.poly.apply(this, arguments);
            }
        }
    },
    x13bcd: {
        hash: function(){
            return function(){
                return multiHashing.x13bcd.apply(this, arguments);
            }
        }
    },
    lyra2re: {
    ...
    argon2: {
        hash: function(){
            return function(){
                return multiHashing.argon2.apply(this, arguments);
            }
        }
    },
    phi: {
        hash: function(){
            return function(){
                return multiHashing.phi.apply(this, arguments);
            }
        }
    },
    skunk: {
